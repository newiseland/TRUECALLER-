...
<b><spoiler>🔥 Powered By @Tmm_heroku_world ©️| @Tmm_truecaller_bot 🤖</spoiler></b>
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Update Channel", url="https://t.me/Tmm_heroku_world"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/Tmm_support_chat")
                    ]
                ]
            )
...
||🔥 Powered By @Taprobane_LK ©️ | @TheTruecaller_Bot 🤖||**""", reply_markup=keyboard)
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/Tmm_truecaller_bot?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
...
||🔥 Powered By @Tmm_heroku_world ©️ | @Tmm_truecaller_bot 🤖||**""", reply_markup=keyboard) 
